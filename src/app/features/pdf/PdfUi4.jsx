...
function PdfUi4({ file_id,chat_data }) {
      ...
      <div className="w-[50%] h-screen bg-[#27272c] text-white  shadow-lg flex flex-col transition-all duration-500">
        <header className="flex justify-between p-3 border-b border-black">
          <div className="flex flex-row items-center justify-start">
            ...
            />
            <h3 className="text-accent text-sm">Chat with your file {file.file_name}</h3>
          </div>
        </header>
        ...
        {/* ///////////////////////////////////////////////////////////////////// */}
          ...
          {messages.map((msg, index) => (
            ...
            >
              ...
              <div
                className={`p-2 max-w-xs rounded-md ${msg.sender === "user" ? "bg-gray-500 text-white" : "bg-gray-200 text-black"}`}
              >
                {msg.text}
              </div>
              {msg.sender === "user" && <FaUser width={50} height={50} />}
            </div>
          ))}
