...
export async function POST(req) {  // <-- FIXED: Use POST instead of handler(req, res)
  try {
    ...
    return NextResponse.json({ message: "Form submitted successfully",data:sentInfo.data }, { status: 200 });
  } catch (error) {
    console.error(error);
