    ...
    return (
        <div className="flex flex-col bg-white items-center justify-center min-h-screen  px-4 sm:px-6 lg:px-6 shadow-md rounded-lg">
            ...
            <form 
                ...
                onSubmit={onSubmit}
            >
           <Link href="/" className="flex text-xl justfy-center items-center hover:bg-blue-500 hover:text-white rounded-xl p-4"> <AiOutlineArrowLeft  />{t('Home')} </Link>

                <h2 className="text-2xl font-semibold text-gray-700 text-center">{t('Login')}</h2>
                ...
                <div className="text-center text-gray-500 mt-4">{t('Or login with:')}</div>
            ...
            <p className="my-3">
                    ...
                    <Link href="register" className="mx-2 underline">  {t('Register')} </Link>
                </p>
        </div>
    );
};
