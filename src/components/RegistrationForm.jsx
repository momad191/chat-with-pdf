          ...
          <>
            <div className="relative">
              ...
              <div className="flex items-center mt-1">
                ...
                />
                <input
                  className="w-full pl-10 pr-4 py-2 border bg-white text-black border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-300 hover:shadow-lg"
                  type="text"
                  name="name"
                  id="name"
